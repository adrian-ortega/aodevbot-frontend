...
import MusicTabPlaylists from '../components/music/tabs/playlists/MusicTabPlaylists.vue'
import MusicTabStats from '../components/music/tabs/stats/MusicTabStats.vue'
...
export default [
  ...
  },
  {
    ...
    name: 'music',
    component: MusicView,
    redirect: { name: 'music.stats' },
    children: [
      {
        path: 'stats',
        component: MusicTabStats,
        name: 'music.stats',
        meta: {
          label: 'Stats'
        }
