...
const tabs = reactive({
  account: {
    label: 'Accounts',
    component: shallowRef(ConfigTabAcount)
  },
  commands: {
    label: 'Commands',
    component: shallowRef(ConfigTabCommands)
  },
  events: {
    label: 'Events',
    component: shallowRef(ConfigTabEvents)
  },
  redeemables: {
    label: 'Redeemables',
    component: shallowRef(ConfigTabRedeemables)
  }
})
